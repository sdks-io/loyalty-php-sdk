...
/**
 * Utility class for initializing ClientAuthorizationToken security credentials.
 */
class ClientAuthorizationTokenCredentialsBuilder
{
    /**
     * @var array
     */
    ...
    /**
     * Initializer for ClientAuthorizationTokenCredentialsBuilder
     *
    ...
    {
        $this->config['client-authorization-token-ClockSkew'] = $oauthClockSkew;
        return $this;
    }

    /**
     * Setter for the OAuthTokenProvider callable with 2 arguments. Arg1 will be the last OAuthToken
     * instance, while Arg2 will be an instance of ClientAuthorizationTokenManager. The return type of
     * callable should be an instance of OAuthToken model.
     *
     * @param callable(OAuthToken, ClientAuthorizationTokenManager): OAuthToken $oauthTokenProvider
     *
     * @return $this
     */
    public function oauthTokenProvider(callable $oauthTokenProvider): self
    {
        $this->config['client-authorization-token-TokenProvider'] = $oauthTokenProvider;
        return $this;
    }
    ...
    {
        $this->config['client-authorization-token-OnTokenUpdate'] = $oauthOnTokenUpdate;
        return $this;
    }
