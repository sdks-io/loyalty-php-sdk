...
class ConfigurationDefaults
{
    ...
    public const PUBLIC_BASIC_TOKEN = '';

    public const PUBLIC_BASIC_TOKEN_2 = '';
    ...
    public const AUTHORIZATION_TOKEN = '';
    ...
    public const CLIENT_AUTHORIZATION_TOKEN_CLOCK_SKEW = 0;
    ...
    public const _ALL = [
        ...
        'publicBasicToken' => self::PUBLIC_BASIC_TOKEN,
        'publicBasicToken2' => self::PUBLIC_BASIC_TOKEN_2,
        ...
        'client-authorization-token-ClockSkew' => self::CLIENT_AUTHORIZATION_TOKEN_CLOCK_SKEW,
        'client-authorization-token-TokenProvider' => null,
        'client-authorization-token-OnTokenUpdate' => null,
